...
const profile = {
  ...
  // City and state only. The resume's street address and phone number are
  // deliberately not on this site — a public page is the wrong place for them.
  location: "Burlington, VT",

  summary: [
    "I automate on-premises data center infrastructure at Cox Automotive — a VMware estate of more than a thousand hosts across multiple datacenters. At this scale a manual process is not just slow — it is an outage with a delay on it. Most of my job is converting things people click into things people review.",
    ...
    "I got here sideways. Thirteen years in enterprise infrastructure: I started scripting fixes in internal IT, moved into running large-scale compute in data centers, and now I write the code that runs it instead of running it by hand. The through-line is a low tolerance for work a machine should be doing.",
  ],
